...
const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 2, title: 'Cinnamon Roll Latte', price: 'Rs 680', image: oreoShakeImg, description: "It's a cinnamon roll in a latte! The caramel and cinnamon perfectly complimenting each other has you casting GEMINO to get another."},
